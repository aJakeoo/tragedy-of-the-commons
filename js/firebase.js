...
// Uploading a device video (the "upload a video" alternative to pasting a
// link) goes straight to Cloudinary now - see js/cloudinaryUpload.js. This
// used to be a Firebase Storage call, but Cloud Storage for Firebase
// requires the Blaze billing plan before its rules can even deploy (see
// output.md Session 12) - Cloudinary's unsigned upload preset needs no
// backend and no billing upgrade.
